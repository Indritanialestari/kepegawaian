...
@section('title', 'Edit Data Karyawan') {{-- Mengatur judul halaman --}}

@section('content')
    <div class="container mx-auto bg-white p-6 rounded-lg shadow-md max-w-2xl">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit Data Karyawan: {{ $dataToEdit->nama }}</h1>
        ...
        {{-- Form action diarahkan ke update() di KaryawanTetapController --}}
        <form action="{{ route('karyawan-tetap.update', $dataToEdit->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $dataToEdit->nama) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nomor_induk" id="nomor_induk" value="{{ old('nomor_induk', $dataToEdit->nomor_induk) }}"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $dataToEdit->tanggal_lahir ? \Carbon\Carbon::parse($dataToEdit->tanggal_lahir)->format('Y-m-d') : '') }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="pendidikan" id="pendidikan" value="{{ old('pendidikan', $dataToEdit->pendidikan) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="keluarga_anak" id="keluarga_anak" value="{{ old('keluarga_anak', $dataToEdit->keluarga_anak) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div id="tetap-fields" class="grid grid-cols-1 md:grid-cols-2 gap-4 col-span-full">
                    <div>
                        ...
                        <input type="date" name="tanggal_masuk" id="tanggal_masuk" value="{{ old('tanggal_masuk', $dataToEdit->tanggal_masuk ? \Carbon\Carbon::parse($dataToEdit->tanggal_masuk)->format('Y-m-d') : '') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div id="kontrak-fields" class="grid grid-cols-1 md:grid-cols-2 gap-4 col-span-full">
                    <div>
                        ...
                        <input type="text" name="masa_kerja" id="masa_kerja" value="{{ old('masa_kerja', $dataToEdit->masa_kerja) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_perhitungan" id="tanggal_perhitungan" value="{{ old('tanggal_perhitungan', $dataToEdit->tanggal_perhitungan ? \Carbon\Carbon::parse($dataToEdit->tanggal_perhitungan)->format('Y-m-d') : '') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="gaji" id="gaji" value="{{ old('gaji', $dataToEdit->gaji) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
