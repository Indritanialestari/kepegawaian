...
$nipAndEntryDateData = [
    'ELA SUHAELA' => ['nip' => '04 92 056', 'tanggal_masuk' => '10/04/1992'],
    'DIDI SURYADI' => ['nip' => '09 93 088', 'tanggal_masuk' => '01/09/1993'],
    'ERNA JUNARA' => ['nip' => '08 07 141', 'tanggal_masuk' => '02/01/2006'],
    'SUHERLAN' => ['nip' => '11 98 104', 'tanggal_masuk' => '01/07/1996'],
    'US US SUKMANA' => ['nip' => '09 93 087', 'tanggal_masuk' => '01/09/1993'],
    'OKKA SUPARDAN' => ['nip' => '11 08 147', 'tanggal_masuk' => '07/08/2006'],
    'WAWAN SUHENDI' => ['nip' => '02 10 151', 'tanggal_masuk' => '01/05/2009'],
    'RIFKI PRIAMBODO' => ['nip' => '05 93 064', 'tanggal_masuk' => '01/05/1993'],
    'ENDI SUHENDI' => ['nip' => '09 93 090', 'tanggal_masuk' => '01/09/1993'],
    'TOTO' => ['nip' => '11 99 115', 'tanggal_masuk' => '12/01/1995'],
    'CECEP A. RIFAI,Ir' => ['nip' => '01 03 128', 'tanggal_masuk' => '18/09/2002'],
    'MAMAN HERMAWAN,S.Sos.' => ['nip' => '11 99 117', 'tanggal_masuk' => '01/09/1997'],
    'NANA SANTANA, S. Sos.' => ['nip' => '04 92 057', 'tanggal_masuk' => '10/04/1992'],
    'IIS KURNIA' => ['nip' => '07 93 071', 'tanggal_masuk' => '01/07/1993'],
    'MOHAMAD RAHMAT JS' => ['nip' => '07 93 075', 'tanggal_masuk' => '01/07/1993'],
    'Hj. ELI MILUWANGI, S.E.' => ['nip' => '05 93 066', 'tanggal_masuk' => '01/05/1993'],
    'INDRIYA SAFARI' => ['nip' => '05 93 067', 'tanggal_masuk' => '01/05/1993'],
    'ADE TRIYANA' => ['nip' => '05 93 068', 'tanggal_masuk' => '01/05/1993'],
    'RIA INTAN SARI' => ['nip' => '07 93 083', 'tanggal_masuk' => '01/07/1993'],
    'NANO PRIATNO, S.E.' => ['nip' => '11 03 130', 'tanggal_masuk' => '25/11/2000'],
    'ADI HARTONO' => ['nip' => '09 93 084', 'tanggal_masuk' => '01/09/1993'],
    'YAYAT SUPRIATNA' => ['nip' => '07 97 099', 'tanggal_masuk' => '01/06/1994'],
    'TOTO PARTAWIJAYA, S.E.' => ['nip' => '05 93 063', 'tanggal_masuk' => '01/05/1993'],
    'AGUS MULYANA, S.Sos.' => ['nip' => '07 97 097', 'tanggal_masuk' => '01/06/1995'],
    'SUBARNAS' => ['nip' => '05 94 092', 'tanggal_masuk' => '01/05/1993'],
    'JADI HERMAWAN, S.T.' => ['nip' => '11 04 134', 'tanggal_masuk' => '01/10/2003'],
    'UCUP RUKMANA' => ['nip' => '09 93 094', 'tanggal_masuk' => '01/04/1994'],
    'ACHMAD SAHIDIN' => ['nip' => '12 97 102', 'tanggal_masuk' => '01/09/1993'],
    'ADE JUNAEDI' => ['nip' => '04 92 055', 'tanggal_masuk' => '10/04/1992'],
    'EMI SUHAEMI' => ['nip' => '07 93 081', 'tanggal_masuk' => '01/07/1993'],
    'AHMAD TOHIDIN' => ['nip' => '07 02 127', 'tanggal_masuk' => '01/06/2001'],
    'LILIS MULYASARI' => ['nip' => '07 93 070', 'tanggal_masuk' => '01/05/1993'],
    'YAYAN SUHERMAYANA' => ['nip' => '11 96 096', 'tanggal_masuk' => '04/10/1995'],
    'SRI RAHAYU D. S.Sos.' => ['nip' => '07 93 073', 'tanggal_masuk' => '01/07/1993'],
    'WAWAN RIDWAN' => ['nip' => '02 99 109', 'tanggal_masuk' => '01/07/1996'],
    'MUMU SUDARMU' => ['nip' => '02 99 110', 'tanggal_masuk' => '01/07/1996'],
    'NENENG SRI IDA W., S.E.' => ['nip' => '07 97 098', 'tanggal_masuk' => '01/06/1995'],
    'ENO C. JUARSIH' => ['nip' => '08 97 100', 'tanggal_masuk' => '01/01/1995'],
    'AANG, S.I.P' => ['nip' => '11 98 106', 'tanggal_masuk' => '18/11/1996'],
    'ROLLAN ROSISENDRA, S.T.' => ['nip' => '07 06 138', 'tanggal_masuk' => '01/04/2005'],
    'SUGANDA' => ['nip' => '01 04 131', 'tanggal_masuk' => '04/12/2002'],
    'ENDI HENDRIYAN, A.Md.' => ['nip' => '01 13 154', 'tanggal_masuk' => '14/01/2013'],
    'JUJU JULIANTINI' => ['nip' => '12 00 122', 'tanggal_masuk' => '01/10/1996'],
    'IKAH ATIKAH' => ['nip' => '12 01 123', 'tanggal_masuk' => '18/11/1996'],
    'YOGA PRATAMA, S. Sos.' => ['nip' => '07 03 129', 'tanggal_masuk' => '05/11/2001'],
    'LILIS SURYANAH' => ['nip' => '06 00 120', 'tanggal_masuk' => '12/10/1996'],
    'DUDI BUDIARTO' => ['nip' => '07 01 125', 'tanggal_masuk' => '01/09/1997'],
    'LILI HAMBALI' => ['nip' => '01 15 172', 'tanggal_masuk' => '05/01/2015'],
    'HENDRA GUNAWAN' => ['nip' => '04 08 144', 'tanggal_masuk' => '22/01/2007'],
    'CUCU RATNASARI, S.E.' => ['nip' => '09 99 112', 'tanggal_masuk' => '01/10/1996'],
    'ADE YANTI HERMIATI, S.E.' => ['nip' => '11 99 118', 'tanggal_masuk' => '01/10/1996'],
    'ANDANG SUHENDAR' => ['nip' => '01 15 173', 'tanggal_masuk' => '05/01/2015'],
    'YANTO' => ['nip' => '07 18 178', 'tanggal_masuk' => '01/07/2018'],
    'IVAN IVANA HANGGADITYA' => ['nip' => '07 18 177', 'tanggal_masuk' => '01/07/2018'],
    'AHMAD' => ['nip' => '05 08 146', 'tanggal_masuk' => '01/06/2006'],
    'DEWI ROSARIO LESTARI, S.E.' => ['nip' => '01 14 164', 'tanggal_masuk' => '02/01/2014'],
    'ASIK FAHDI H, ST' => ['nip' => '11 07 143', 'tanggal_masuk' => '13/11/2006'],
    'NENI SUHERNI, S.E.' => ['nip' => '01 15 170', 'tanggal_masuk' => '05/01/2015'],
    'TINTIN USWATUN HASANAH, A.Md.' => ['nip' => '07 12 152', 'tanggal_masuk' => '05/07/2012'],
    'PANJI LINGGA WIHARJA' => ['nip' => '08 07 140', 'tanggal_masuk' => '02/01/2006'],
    'LALA KOMALADEWI' => ['nip' => '08 07 139', 'tanggal_masuk' => '20/02/2007'],
    'HENDRIYANTO' => ['nip' => '01 13 155', 'tanggal_masuk' => '14/01/2013'],
    'YONO' => ['nip' => '09 04 133', 'tanggal_masuk' => '01/09/2003'],
    'DIAN PRIATNA' => ['nip' => '07 19 188', 'tanggal_masuk' => '01/07/2019'],
    'ADJID HALIM' => ['nip' => '01 05 135', 'tanggal_masuk' => '13/01/2004'],
    'GUSMANA' => ['nip' => '07 13 158', 'tanggal_masuk' => '01/07/2013'],
    'FAHRUROJI, S.T.' => ['nip' => '07 18 184', 'tanggal_masuk' => '01/07/2018'],
    'RAHMAN TAUFIK' => ['nip' => '04 08 145', 'tanggal_masuk' => '12/07/2007'],
    'ENDANG RUSMANA' => ['nip' => '07 18 175', 'tanggal_masuk' => '01/07/2018'],
    'BUDI SUCIPTO' => ['nip' => '03 09 149', 'tanggal_masuk' => '09/07/2007'],
    'WIDI FIRLIANI, Amd.' => ['nip' => '03 09 146', 'tanggal_masuk' => '19/11/2007'],
    'ADJI NOER REISMADJI S.' => ['nip' => '07 20 191', 'tanggal_masuk' => '01/07/2020'],
    'ANWAR ABDURRAHMAN, S.T.' => ['nip' => '07 20 200', 'tanggal_masuk' => '01/07/2020'],
    'TANDRA TRIYANTO' => ['nip' => '07 20 207', 'tanggal_masuk' => '01/07/2020'],
    'DUDI SUHARWANTO' => ['nip' => '07 13 157', 'tanggal_masuk' => '01/07/2013'],
    'ADAM FAUZI GOJALI, S.E.' => ['nip' => '07 18 187', 'tanggal_masuk' => '01/07/2018'],
    'YAYAN SOPYAN' => ['nip' => '07 14 166', 'tanggal_masuk' => '01/07/2014'],
    'YASIR HANIF INDRAPRAJA, S.T.' => ['nip' => '07 20 202', 'tanggal_masuk' => '01/07/2020'],
    'UMAR SA\'ID' => ['nip' => '02 10 150', 'tanggal_masuk' => '21/05/2008'],
    'AEF SAEFUDIN ROMADHON' => ['nip' => '01 21 210', 'tanggal_masuk' => '01/01/2021'],
    'AA HERDI AHMAD S., S.E.' => ['nip' => '07 14 165', 'tanggal_masuk' => '01/07/2014'],
    'GILANG NUGRAHA P., S.Ip' => ['nip' => '07 18 180', 'tanggal_masuk' => '01/07/2018'],
    'INDRA SUPRIATNO, S.I.P.' => ['nip' => '07 18 185', 'tanggal_masuk' => '01/07/2018'],
    'IFAN RIFANDI' => ['nip' => '01 15 169', 'tanggal_masuk' => '05/01/2015'],
    'ANGELA ROSVIANTI' => ['nip' => '01 14 160', 'tanggal_masuk' => '02/01/2014'],
    'ARIEF HADDAD' => ['nip' => '01 21 211', 'tanggal_masuk' => '01/01/2021'],
    'WAHONO SUSILO' => ['nip' => '01 14 159', 'tanggal_masuk' => '02/01/2014'],
    'SEPTIAN SAMYA NUGRAHA, S.T.' => ['nip' => '01 15 174', 'tanggal_masuk' => '05/01/2015'],
    'WAWAN HERMAWAN' => ['nip' => '07 18 179', 'tanggal_masuk' => '01/07/2018'],
    'DADANG SUHENDAR' => ['nip' => '01 15 171', 'tanggal_masuk' => '05/01/2015'],
    'LILI SUHALI, S.E.' => ['nip' => '07 20 198', 'tanggal_masuk' => '01/07/2020'],
    'DIAN RAMADHAN' => ['nip' => '07 20 196', 'tanggal_masuk' => '01/07/2020'],
    'IZA SHOBIZA' => ['nip' => '07 14 167', 'tanggal_masuk' => '01/07/2014'],
    'ANDRI YULIONO' => ['nip' => '01 24 231', 'tanggal_masuk' => '01/01/2024'],
    'DIKKY CHANRA DERMAWAN, S.E.' => ['nip' => '07 20 199', 'tanggal_masuk' => '01/07/2020'],
    'MOH IQBAL FAUZI' => ['nip' => '01 14 161', 'tanggal_masuk' => '02/01/2014'],
    'SITI ROHAYATI' => ['nip' => '01 14 163', 'tanggal_masuk' => '02/01/2014'],
    'DIMAS PRAMESETIA, S.T' => ['nip' => '07 23 222', 'tanggal_masuk' => '01/07/2023'],
    'ATIN LISNAWATI' => ['nip' => '07 20 208', 'tanggal_masuk' => '01/07/2020'],
    'TRIA ADHIMU KURNIA, S.Si.' => ['nip' => '07 20 201', 'tanggal_masuk' => '01/07/2020'],
    'MOH FAJRI PRIYANTO, S.T.' => ['nip' => '01 14 162', 'tanggal_masuk' => '02/01/2014'],
    'ENOK YULIANTI' => ['nip' => '07 20 203', 'tanggal_masuk' => '01/07/2020'],
    'WISNU FADILA' => ['nip' => '01 21 212', 'tanggal_masuk' => '01/01/2021'],
    'YOGI BAHARI, S.A.P' => ['nip' => '01 13 156', 'tanggal_masuk' => '14/01/2013'],
    'ARIEF ISKANDAR RAKHMAN' => ['nip' => '07 18 176', 'tanggal_masuk' => '01/07/2018'],
    'BUDY NURICHSYAN' => ['nip' => '01 21 213', 'tanggal_masuk' => '01/01/2021'],
    'FANJI SULISTIO' => ['nip' => '07 20 205', 'tanggal_masuk' => '01/07/2020'],
    'SITI RUBAIAH' => ['nip' => '07 18 186', 'tanggal_masuk' => '01/07/2018'],
    'GUGUN GUMELAR' => ['nip' => '07 18 183', 'tanggal_masuk' => '01/07/2018'],
    'RINA NURAENA' => ['nip' => '01 21 214', 'tanggal_masuk' => '01/01/2021'],
    ...
    'JENITA NURMALA' => ['nip' => '01 24 224', 'tanggal_masuk' => '01/01/2024'],
    'AEF PUJI' => ['nip' => '01 21 215', 'tanggal_masuk' => '01/01/2021'],
    'TEMMY KHIBRAN PRATMA' => ['nip' => '01 24 226', 'tanggal_masuk' => '01/01/2024'],
    'PASHA ANUGRAH SANDIANSAH' => ['nip' => '07 20 209', 'tanggal_masuk' => '01/07/2020'],
    'ANGGA RAHMAWAN' => ['nip' => '07 18 181', 'tanggal_masuk' => '01/07/2018'],
    'CINDYA MEITA ANANTASARI' => ['nip' => '07 20 194', 'tanggal_masuk' => '01/07/2020'],
    'ADE RAHMAN HANIFUDIN' => ['nip' => '07 23 220', 'tanggal_masuk' => '01/07/2023'],
    'GUGUN GUNAWAN' => ['nip' => '07 20 197', 'tanggal_masuk' => '01/07/2020'],
    'SHINTA ANNISA' => ['nip' => '01 24 230', 'tanggal_masuk' => '01/01/2024'],
    'AFRIZAL IQBALI' => ['nip' => '07 20 204', 'tanggal_masuk' => '01/07/2020'],
    'REZA ADITYA SANTOSO' => ['nip' => '07 23 221', 'tanggal_masuk' => '01/07/2023'],
    'YORI KARSONO' => ['nip' => '01 21 217', 'tanggal_masuk' => '01/01/2021'],
    'MUHAMMAD IQBAL RAMADHAN' => ['nip' => '01 24 225', 'tanggal_masuk' => '01/01/2024'],
    'MURY MAHENDRAYANA' => ['nip' => '01 24 227', 'tanggal_masuk' => '01/01/2024'],
    'GIBRAL THORIQ' => ['nip' => '01 24 229', 'tanggal_masuk' => '01/01/2024'],
    'NIA FITRIANA FORTUNA,Spd' => ['nip' => '07 23 218', 'tanggal_masuk' => null], // Tanggal masuk tidak tersedia di data
];
